...
'object'==typeof exports&&'undefined'!=typeof module?module.exports=r():'function'==typeof define&&define.amd?define(r):(e='undefined'!=typeof globalThis?globalThis:e||self).Pristine=r();
  ...
  'use strict'; const e={en: {required: 'This field is required', email: 'This field requires a valid e-mail address', number: 'This field requires a number', integer: 'This field requires an integer value', url: 'This field requires a valid website URL', tel: 'This field requires a valid telephone number', maxlength: 'This fields length must be < ${1}', minlength: 'This fields length must be > ${1}', min: 'Minimum value for this field is ${1}', max: 'Maximum value for this field is ${1}', pattern: 'Please match the requested format', equals: 'The two fields do not match'}}; function r(e) {
    const r=arguments; return this.replace(/\${([^{}]*)}/g, (function(e, t) {
      return r[t];
    }));
  } function t(e) {
    return e.pristine.self.form.querySelectorAll('input[name="'+e.getAttribute('name')+'"]:checked').length;
  } let n={classTo: 'form-group', errorClass: 'has-danger', successClass: 'has-success', errorTextParent: 'form-group', errorTextTag: 'div', errorTextClass: 'text-help'}; const i=['required', 'min', 'max', 'minlength', 'maxlength', 'pattern']; const s=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/; const a=/-message(?:-([a-z]{2}(?:_[A-Z]{2})?))?/; let o='en'; const l={}; const u=function(e, r) {
    ...
    const f=this; function c(e, r, t, n) {
      ...
      for (var n=[], i=!0, s=0; t.validators[s]; s++) {
        const a=t.validators[s]; const l=t.params[a.name]?t.params[a.name]:[]; if (l[0]=t.input.value, !a.fn.apply(t.input, l)&&(i=!1, 'function'==typeof a.msg?n.push(a.msg(t.input.value, l)):'string'==typeof a.msg?n.push(r.apply(a.msg, l)):a.msg===Object(a.msg)&&a.msg[o]?n.push(r.apply(a.msg[o], l)):t.messages[o]&&t.messages[o][a.name]?n.push(r.apply(t.messages[o][a.name], l)):e[o]&&e[o][a.name]&&n.push(r.apply(e[o][a.name], l)), !0===a.halt)) break;
      } return t.errors=n, i;
    } function m(e) {
      if (e.errorElements) return e.errorElements; const r=function(e, r) {
        for (;(e=e.parentElement)&&!e.classList.contains(r););return e;
      }(e.input, f.config.classTo); let t=null; let n=null; return (t=f.config.classTo===f.config.errorTextParent?r:r.querySelector('.'+f.config.errorTextParent))&&((n=t.querySelector('.pristine-error'))||((n=document.createElement(f.config.errorTextTag)).className='pristine-error '+f.config.errorTextClass, t.appendChild(n), n.pristineDisplay=n.style.display)), e.errorElements=[r, n];
    } function d(e) {
      const r=m(e); const t=r[0]; const n=r[1]; t&&(t.classList.remove(f.config.successClass), t.classList.add(f.config.errorClass)), n&&(n.innerHTML=e.errors.join('<br/>'), n.style.display=n.pristineDisplay||'');
    } function h(e) {
      const r=function(e) {
        const r=m(e); const t=r[0]; const n=r[1]; return t&&(t.classList.remove(f.config.errorClass), t.classList.remove(f.config.successClass)), n&&(n.innerHTML='', n.style.display='none'), r;
      }(e)[0]; r&&r.classList.add(f.config.successClass);
    } return function(e, r, t) {
      e.setAttribute('novalidate', 'true'), f.form=e, f.config=function(e, r) {
        for (const t in r)t in e||(e[t]=r[t]); return e;
        ...
        const r=[]; const t={}; const n={}; return [].forEach.call(e.attributes, (function(e) {
          if (/^data-pristine-/.test(e.name)) {
            let s=e.name.substr(14); const o=s.match(a); if (null!==o) {
      ...
      r=e&&!0===r||!0===e; let t=f.fields; !0!==e&&!1!==e&&(e instanceof HTMLElement?t=[e.pristine]:(e instanceof NodeList||e instanceof(window.$||Array)||e instanceof Array)&&(t=Array.from(e).map((function(e) {
        return e.pristine;
...
e instanceof HTMLElement?(e.pristine.validators.push({fn: r, msg: t, priority: n, halt: i}), e.pristine.validators.sort((function(e, r) {
  return r.priority-e.priority;
}))):console.warn('The parameter elem must be a dom element');
    }, f.addError=function(e, r) {
      (e=e.length?e[0]:e).pristine.errors.push(r), d(e.pristine);
    }, f.reset=function() {
      for (let e=0; f.fields[e]; e++)f.fields[e].errorElements=null; Array.from(f.form.querySelectorAll('.pristine-error')).map((function(e) {
    ...
    const n=e.hasOwnProperty(r)?e[r]:e[r]={}; Object.keys(t).forEach((function(e, r) {
      n[e]=t[e];
    }));
